              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Wrap(spacing: 8, children: controller.doctor.specialization.map((s) => _chip(s)).toList()),
                    if (controller.doctor.languagesKnown.isNotEmpty) ...[
                      const SizedBox(height: 24),
                      _buildSectionTitle('Languages Known'),
                      const SizedBox(height: 8),
                      Wrap(spacing: 8, children: controller.doctor.languagesKnown.map((l) => _chip(l)).toList()),
                    ],
                    const SizedBox(height: 24),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${controller.doctor.qualification.join(", ")} - ${controller.doctor.specialization.join(", ")}',
  ...
  Widget _buildStats() {
    return Row(
      ...
      children: [
        ...
        _statItem('Rating', controller.doctor.rating.toString(), Icons.star_rounded, Colors.orange, onTap: controller.scrollToReviews),
        _statItem(
          'Reviews',
        ...
        Obx(() {
          ...
          if (controller.reviews.isEmpty) {
            return Container(
              ...
              child: const Center(
                child: Text('No reviews yet. Be the first to rate!', style: TextStyle(color: AppColors.textSecondary, fontSize: 13)),
              ),
            );
          }
